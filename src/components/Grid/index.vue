...
// Injection to start folding the index
...
// Find the field that needs to start collapsing index
const findIndex = () => {
	...
	// Calculation suffix Columns occupied by
	let suffixCols = 0;
	if (suffix) {
		suffixCols =
...
// When the breakpoint changes Execution findIndex
watch(
	() => breakPoint.value,
	() => {
