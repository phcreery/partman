...
import type { TabsState, TabsMenuProps, TabsMenuActions } from "@/stores/interface";
import piniaPersistConfig from "@/stores/helper/persist";

const keepAliveStore = useKeepAliveStore();

export const useTabsStore = defineStore<string, TabsState, {}, TabsMenuActions>("geeker-tabs", {
  state: (): TabsState => ({
    tabsMenuList: []
  }),
  actions: {
