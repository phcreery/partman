...
export const loginApi = (params: ReqLoginForm) => {
  return http.post<ResLogin>(SERVER_ENDPOINTS.geeker + `/login`, params, { loading: false }) // 正常 post json 请求  ==>  application/json
...
export const getAuthMenuListApi = () => {
  return http.get<MenuOptions[]>(SERVER_ENDPOINTS.geeker + `/menu/list`, {}, { loading: false })
...
export const getAuthButtonListApi = () => {
  return http.get<ResAuthButtons>(SERVER_ENDPOINTS.geeker + `/auth/buttons`, {}, { loading: false })
...
export const logoutApi = () => {
  return http.post(SERVER_ENDPOINTS.geeker + `/logout`)
}
